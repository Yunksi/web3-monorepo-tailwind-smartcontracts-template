...
export const Sidebar: React.FC<ISidebarProps> = ({}) => {
  ...
  return (
    <>
      <aside className="dark:bg-dark xs:w-80 top-0 left-0 z-40 hidden h-full max-w-full border-r border-dashed border-gray-200 dark:border-gray-700 xl:fixed xl:block xl:w-72 2xl:w-80">
